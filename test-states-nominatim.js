...
// Test key states including Illinois and Texas
const TEST_STATES = ['Illinois', 'Texas', 'California', 'New York', 'Florida'];
...
async function testStates() {
    console.log(`Testing weather lookups for ${TEST_STATES.length} key states using Nominatim...`);
